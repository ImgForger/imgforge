...
print_final() {
    ...
    echo "       ${YELLOW}sudo apt-get remove docker-ce docker-ce-cli containerd.io${NC} (Ubuntu/Debian)"
    echo "       ${YELLOW}sudo yum remove docker-ce docker-ce-cli containerd.io${NC} (CentOS/RHEL)"
    echo ""
